...
I really mean it, you can copy-paste the code with a well used ```ctrl+c``` and  ```ctrl+v```, modify the code or even entirely rewrite it, I dont care. Feel free to make anithing with it (if its ilegal or could get me in trouble, just dont say that you get the templates from me).  
I hope that you will have more fun using my code tahn you or me writing it and if you fing any mistakes, contact me.
